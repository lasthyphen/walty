...
export function stakingDataToCsvRow(rowData: CsvRowStakingData): string[] {
    let rewardAmtDjtx = rowData.isRewardOwner
        ? rowData.rewardAmtDjtx.toString()
    ...
    return [
        ...
        rowData.djtxPrice?.toFixed(2) || '-',
        rewardAmtDjtx,
        rewardAmtUSD,
    ]
}

export function djtxTransferDataToCsvRow(rowData: CsvRowDjtxTransferData): string[] {
