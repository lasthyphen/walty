<template>
    <div class="staking_tx">
        <template v-if="isRewarded">
            ...
            <div class="data_row reward_row">
                <p>DJTX Price at reward date</p>
                <p v-if="rewardDateDjtxPrice">{{ rewardDateDjtxPrice.toFixed(2) }} USD</p>
                <p v-else>Unknown</p>
            </div>
            <div class="data_row reward_row">
            ...
            <div class="data_row">
                ...
                <p class="amt">{{ rewardAmtText.toLocaleString() }} DJTX</p>
            </div>
        </template>
