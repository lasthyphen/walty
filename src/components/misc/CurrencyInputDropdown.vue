            ...
            <div class="max_in_cont hover_border">
                ...
                <div class="col_big_in">
                    <big-num-input
                        ...
                        :disabled="disabled"
                    ></big-num-input>
                    <p class="usd_val" :active="isDjtx">${{ amountUSD.toLocaleString(2) }}</p>
                </div>
            </div>
            <BalanceDropdown
...
export default class CurrencyInputDropdown extends Vue {
    ...
    get isDjtx(): boolean {
        if (this.asset_now.id === this.djtxAsset?.id) return true
        return false
    }
