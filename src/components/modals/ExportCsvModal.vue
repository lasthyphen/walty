...
export default class ExportCsvModal extends Vue {
    ...
    submit() {
        ...
        for (var i = 0; i < this.stakingTxs.length; i++) {
            ...
            let djtxPrice = getPriceAtUnixTime(rewardMoment.unix() * 1000)
            ...
            let rewardAmtUsd = djtxPrice ? rewardAmtBig.mul(djtxPrice) : undefined
        ...
        let headers = [
            ...
            'Stake Duration',
            'Reward Date',
            'DJTX Price at Reward Date',
            'Reward Received (DJTX)',
            'Reward Received (USD)',
        ]
