            ...
            <div>
                <div v-if="!isSuccess" class="summary">
                    ...
                    <div>
                        ...
                        <p v-if="currency_type === 'DJTX'">
                            {{ estimatedReward.toLocaleString(2) }} DJTX
                        </p>
                    ...
                    <div>
                        ...
                        <p v-if="currency_type === 'DJTX'">
                            {{ totalFeeBig.toLocaleString(2) }} DJTX
                        </p>
                        <p v-if="currency_type === 'USD'">
...
import { Defaults, ONEDJTX } from 'avalanche/dist/utils'
...
export default class AddDelegator extends Vue {
    ...
    get totalFeeUsdBig() {
        return this.totalFeeBig.times(this.djtxPrice)
    }
