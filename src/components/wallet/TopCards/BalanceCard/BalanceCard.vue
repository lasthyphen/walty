            ...
            <div class="header">
                <div class="refresh">
                    ...
                    <button v-else @click="updateBalance">
                        <img v-if="$root.theme === 'day'" src="@/assets/theme_toggle/refday.svg" />
                        <img v-else src="@/assets/theme_toggle/refnight.svg" />
                    </button>
                </div>
                <h4>{{ $t('top.title2') }}</h4>
            ...
            <div class="alt_info">
                <div class="alt_non_breakdown" v-if="!isBreakdown">
                    <div>
                        ...
                        <p>{{ unlockedText }} ĐJT</p>
                    </div>
                    <div>
                        <label>{{ $t('top.locked') }}</label>
                        <p>{{ balanceTextLocked }} ĐJT</p>
                    </div>
                    <div>
                ...
                <div class="alt_breakdown" v-else>
                    <div>
                        ...
                        <p>{{ avmUnlocked | cleanDjtxBN }} ĐJT</p>
                        <label>{{ $t('top.balance.available') }} (P)</label>
                        <p>{{ platformUnlocked | cleanDjtxBN }} ĐJT</p>
                        <label>{{ $t('top.balance.available') }} (C)</label>
                        <p>{{ evmUnlocked | cleanDjtxBN }} ĐJT</p>
                    </div>
                    <div>
                        <label>{{ $t('top.balance.locked') }} (X)</label>
                        <p>{{ avmLocked | cleanDjtxBN }} ĐJT</p>
                        <label>{{ $t('top.balance.locked') }} (P)</label>
                        <p>{{ platformLocked | cleanDjtxBN }} ĐJT</p>
                        <label>{{ $t('top.balance.locked_stake') }} (P)</label>
                        <p>{{ platformLockedStakeable | cleanDjtxBN }} ĐJT</p>
                    </div>
                    <div>
                        <label>{{ $t('top.balance.stake') }}</label>
                        <p>{{ stakingText }} ĐJT</p>
