<template>
    <div class="chain_select">
        <button @click="setChain('X')" :active="chain === 'X'">VALUE</button>
        <button @click="setChain('P')" :active="chain === 'P'">UTILITY</button>
        <button @click="setChain('C')" :active="chain === 'C'" v-if="isEVMSupported">ASSETS</button>
    </div>
</template>
<script lang="ts">
