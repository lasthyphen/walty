# Avalanche (DJTX) Wallet

This is the frontend Vue.js application for the Avalanche (DJTX) Wallet.
...
-   Avalanche API: `https://api.djtx.network:443`
-   Explorer API: `https://explorerapi.djtx.network`

##### Fuji (Testnet)

-   Avalanche API: `https://api.djtx-test.network:443`
-   Explorer API: `https://explorerapi.djtx-test.network`
